...
PBTVMF4=function(x,alpha)
{
  ...
  y1=(a[1]*r_bar1[1]*k_hat_0[[1]]+a[2]*r_bar1[2]*k_hat_0[[2]]+a[3]*r_bar1[3]*k_hat_0[[3]]+a[4]*r_bar1[4]*k_hat_0[[4]])
  mu_hat=y1/sqrt(sum(y1**2))
  N=sum(sequence_of_n)
  A1=a[1]*r_bar1[1]+a[2]*r_bar1[2]+a[3]*r_bar1[3]+a[4]*r_bar1[4]
  A2=a[1]*y[[1]]+a[2]*y[[2]]+a[3]*y[[3]]+a[4]*y[[4]]
  A3=sqrt(sum(A2**2))
  ...
  for(h in 1:H)
  {
    ...
    B1=b[1]*g_bar1[1]+b[2]*g_bar1[2]+b[3]*g_bar1[3]+b[4]*g_bar1[4]
    B2=b[1]*z[[1]]+b[2]*z[[2]]+b[3]*z[[3]]+b[4]*z[[4]]
    B3=sqrt(sum(B2**2))
