...
NBTVMF5=function(x,alpha)
{
  ...
  #l1=list(D1=D1,D2=O,D3=O,D4=-D1,D5=D1,D6=O,D7=O,D8=-D1,D9=D1,D10=O,D11=O,D12=-D1)
  l1=list(D1=D1,D2=O,D3=-D1)
  m=array(c("D1","D2","D2","D2","D3","D1","D2","D2","D2","D3","D1","D2","D2","D2",
            "D3","D1","D2","D2","D2","D3"),c((k-1),k))
