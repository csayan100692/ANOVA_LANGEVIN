...
NBFT4=function(x,alpha)
{
  ...
  M1=vector(mode = "list", length = k)
  M2=vector(mode = "list", length = k)
  M3=vector(mode = "list", length = k)
  M4=vector(mode = "list", length = k)
  ...
  ###############################################################
    ...
    r=sqrt(sum((l[1]*y[[1]]+l[2]*y[[2]]+l[3]*y[[3]]+l[4]*y[[4]])^2))
    ...
    mu1=l[1]*r_bar1[1]*mu_hat_0[[1]]+l[2]*r_bar1[2]*mu_hat_0[[2]]+l[3]*r_bar1[3]*mu_hat_0[[3]]+l[4]*r_bar1[4]*mu_hat_0[[4]]
    ...
    for(h in 1:H) #inner loop
    {
      ...
      r1=sqrt(sum((l1[1]*z[[1]]+l1[2]*z[[2]]+l1[3]*z[[3]]+l1[4]*z[[4]])^2))
